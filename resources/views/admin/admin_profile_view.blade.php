    ...
    <section class="content">
        ...
        <div class="box box-widget widget-user">
					...
					<div class="widget-user-image">
					  <img class="rounded-circle" src="{{(!empty($adminData->profile_photo_path))?url('upload/admin_images/'.$adminData->profile_photo_path): url('upload/admin_images/default.jpg')}}">
					</div>
